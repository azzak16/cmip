...
<script>
    var datatable = $('#datatable').DataTable({
        ajax: '<?= Env::get('BASE_URL') ?>/spk/data',
        columns: [
            {
            ...
            },
            {
                ...
                render: function(data, type, row, meta) {
                    ...
                    var html = `<div>
                                    <a href="<?= Env::get('BASE_URL') ?>/spk/edit/${row.id}" class="btn btn-sm btn-outline-info btn-edit" ><i class="fas fa-pencil"></i></a>
                                    <a href="<?= Env::get('BASE_URL') ?>/spk/view/${row.id}" class="btn btn-sm btn-outline-warning btn-view" ><i class="fas fa-eye"></i></a>
                                    <a class="btn btn-sm btn-outline-danger btn-delete" data-id="${row.id}"><i class="fas fa-trash"></i></a>
                                    <a href="<?= Env::get('BASE_URL') ?>/spk/print/${row.id}" target="_blank" class="btn btn-sm btn-outline-primary"><i class="fas fa-print"></i></a>
                                </div>`;
